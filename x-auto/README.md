...
6. 実行日の翌日に対応する thread ファイルを選択し、夜投稿本文・リプが200〜250文字であることを検証
...
- 夜20時投稿は本文・リプとも200〜250文字。200未満・250超過は投稿せずエラーにする
...
- 投稿冒頭の固定表記は必ず `🌈Result M/D` とする
- `答え合わせ`、順位、ランキング表現は使用禁止
